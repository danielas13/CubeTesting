...
{
	//LH TODO: remove this -> only used for testing -> when this is removed
	// Lighting.cginc is the same as the original file...
	...
	//c.rgb = s.Albedo * diff * light.color;
	//c.rgb = half3(1,0,0) * spec;
