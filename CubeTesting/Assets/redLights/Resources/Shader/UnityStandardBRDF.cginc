...
inline half LambertTerm (half3 normal, half3 lightDir)
{
	...
	//TODO/FIXME: this could be needed for legacy shader...
	// N*L is performed in LightRectIndex
	//return 1.0;
...
// redPlant PBS Wrapper

// Mapping of PBS Functions to custom redPlant Area Light function
//TODO: check for alpha value support (UNITY_PROPER_PBS_TRANSPARENCY)

//TODO: check for better macros to distinguish
#ifdef DIRECTIONAL_COOKIE
#define REDPLANT_CUSTOMPBS
#endif

// REPLICATED from UnityPBSLighting.cginc for custom function injection
#if (SHADER_TARGET < 30)
	// Fallback to low fidelity one for pre-SM3.0
	#define REDPLANT_BRDF_PBS BRDF3_Unity_PBS_RedPlant
#elif defined(SHADER_API_MOBILE)
	// Somewhat simplified for mobile
	#define REDPLANT_BRDF_PBS BRDF2_Unity_PBS_RedPlant
#else
	// Full quality for SM3+ PC / consoles
	#define REDPLANT_BRDF_PBS BRDF1_Unity_PBS_RedPlant
#endif
...
// redPlant Custom BRDF
#include "redPlantBRDF.cginc"
